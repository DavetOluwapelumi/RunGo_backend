...
export class AdminDriverController {
  ...
  @Post('newDriver')
  public async addDriverManually(
  ...
  @Get(':identifier')
  public async findDriverByIdentifier(
    @Param('identifier') identifier: string,
  ): Promise<ApiResponse<Driver>> {
    const driver =
      await this.adminDriverService.findDriverByIdentifier(identifier);
  ...
  public async updateDriverDetails(
    ...
    const driver = await this.adminDriverService.updateDriverDetails(
      identifier,
      updateData,
    );
