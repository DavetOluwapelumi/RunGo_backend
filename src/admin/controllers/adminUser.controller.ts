...
export class UserAdminController {
    ...
    public async suspendUser(@Param('identifier') identifier: string): Promise<ApiResponse<void>> {
    ...
    public async unsuspendUser(@Param('identifier') identifier: string): Promise<ApiResponse<void>> {
        await this.userAdminService.unsuspendUser(identifier);
        return new ApiResponse('User unsuspended successfully', null);
    }

    @Delete(':identifier')
    public async deleteUser(@Param('identifier') identifier: string): Promise<ApiResponse<void>> {
